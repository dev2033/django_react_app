...
class BlogPostQuerySet(models.QuerySet):
    """Кастомный QuerySet для поиска объекта по его title"""
...
class BlogPostManager(models.Manager):
    """
    Менеджер поста, не показывает те посты, которые находятся в архиве
    (стоят с активным чекбоксом in_archive)
    """
